...
par(mfrow=c(1,3))
num_indvs=100
hist(null_100$T_rep[,1],xlab="T",main=paste0("T for", num_indvs," Subjects", " with", num_replications," simulations"))
num_indvs=500
hist(null_500$T_rep[,1],xlab="T",main=paste0("T for", num_indvs," Subjects", " with", num_replications," simulations"))
num_indvs=1000
hist(null_1000$T_rep[,1],xlab="T",main=paste0("T for", num_indvs," Subjects", " with", num_replications," simulations"))
