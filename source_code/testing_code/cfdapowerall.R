...
#n=300
 n100t250power=sim_cfdatest(3,100,250,0,1,1,1000,0.01,0.99,3)
 n100t500power=sim_cfdatest(3,100,500,0,1,1,1000,0.01,0.99,3)
 n100t2000power=sim_cfdatest(3,100,2000,0,1,1,1000,0.01,0.99,3)

#n=500
n500t250power=sim_cfdatest(3,500,250,0,1,1,1000,0.01,0.99,3)
n500t500power=sim_cfdatest(3,500,500,0,1,1,1000,0.01,0.99,3)
n500t2000power=sim_cfdatest(3,500,2000,0,1,1,1000,0.01,0.99,3)
#n=700
# n700t250power=sim_cfdatest(3,700,250,0,1,1,5000,0.01,0.99,3)
# n700t500power=sim_cfdatest(3,700,500,0,1,1,5000,0.01,0.99,3)
# n700t2000power=sim_cfdatest(3,700,2000,0,1,1,5000,0.01,0.99,3)
#n=1000

n1000t250power=sim_cfdatest(3,1000,250,0,1,1,1000,0.01,0.99,3)
n1000t500power=sim_cfdatest(3,1000,500,0,1,1,1000,0.01,0.99,3)
n1000t2000power=sim_cfdatest(3,1000,2000,0,1,1,1000,0.01,0.99,3)

save(n100t250power,n100t500power,n100t2000power,
  n500t250power,n500t500power,n500t2000power,
     n1000t250power,n1000t500power,n1000t2000power,
     file="cfdapower.RData")
#save(n100t250,file="typeIerrorn100t250.RData")