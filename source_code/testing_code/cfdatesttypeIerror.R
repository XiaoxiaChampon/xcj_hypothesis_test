...
#save(n100t250,n100t500,n100t2000,file="cfdatypeIerror.RData")
#save(n100t250,file="typeIerrorn100t250.RData")
######################################
#load("typeIerrorn100t250.RData")
# n100t250
# RLRT    p-value          n datapoints 
# 0.308      0.052    100.000    250.000

#load("typeIerror1002000.RData")
# n100t2000
# RLRT    p-value          n datapoints 
# 0.295      0.052    100.000   2000.000 

# load("typeIerror100500.RData")
# n100t500
# RLRT    p-value          n datapoints 
# 0.321      0.050    100.000    500.000 
#########
n500t250=sim_cfdatest(3,500,250,0,1,1,5000,0.01,0.99,4)
n500t500=sim_cfdatest(3,500,500,0,1,1,5000,0.01,0.99,4)
n500t2000=sim_cfdatest(3,500,2000,0,1,1,5000,0.01,0.99,4)
save(n500t250,n500t500,n500t2000,file="cfdatypeIerrorn500.RData")

#############
n1000t250=sim_cfdatest(3,500,250,0,1,1,5000,0.01,0.99,4)
n1000t500=sim_cfdatest(3,500,500,0,1,1,5000,0.01,0.99,4)
n1000t2000=sim_cfdatest(3,500,2000,0,1,1,5000,0.01,0.99,4)
save(n1000t250,n1000t500,n1000t2000,file="cfdatypeIerrorn1000.RData")
